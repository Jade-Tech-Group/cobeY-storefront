...
const selectedTerms = ref(getFilter('department') || []);

const route = useRoute();
const departmentSlug = route.params.departmentSlug;
if (departmentSlug) selectedTerms.value = [departmentSlug];
...
const checkboxChanged = () => {
  setFilter('department', selectedTerms.value);
};
</script>
